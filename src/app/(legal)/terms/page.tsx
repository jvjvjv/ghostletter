...
const Terms = () => (
  <main className="page">
    ...
    <p>The App shall not be used for illegal purposes under any circumstances. You agree not to use the App to:</p>
    <ul>
    ...
    <h2>4. Ephemeral Nature of Content</h2>
    <p>
    ...
    <p>
      ...
      <a href="mailto:m.jasonvertucio@gmail.com">support@ghostletter.app</a>.
    </p>
  </main>
);
